...
await runWorkerLoop(ctx, { "video.render": renderVideoJob, "video.slideshow": renderSlideshowJob, "series.run": seriesRunJob, "community.scan": communityScanJob, "weekly.report": weeklyReportJob, "geo.measure": geoMeasureJob }, { signal: ac.signal });
