...
import { seriesRunJob } from "./agents/series/job.js";
import { metricsFetchJob, publishDueJob } from "./publish/job.js";
...
await runWorkerLoop(ctx, { "video.render": renderVideoJob, "video.slideshow": renderSlideshowJob, "series.run": seriesRunJob, "publish.due": publishDueJob, "metrics.fetch": metricsFetchJob, "community.scan": communityScanJob, "weekly.report": weeklyReportJob, "geo.measure": geoMeasureJob }, { signal: ac.signal });
