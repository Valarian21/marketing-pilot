...
await runWorkerLoop(ctx, { "video.render": renderVideoJob, "community.scan": communityScanJob, "weekly.report": weeklyReportJob, "geo.measure": geoMeasureJob }, { signal: ac.signal });
