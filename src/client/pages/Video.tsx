...
export function VideoPage() {
  ...
  return (
    <>
      ...
      {view.musicTracks === 0 && <p className="mp-small mp-muted mp-note">Ohne Musikbett – Reels werden stumm gerendert. Tracks unter <Link to="/music">Musik</Link> hochladen.</p>}
