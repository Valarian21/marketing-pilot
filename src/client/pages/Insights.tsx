...
export function InsightsPage() {
  ...
  return (
    <>
      <ProjectNav id={id} />
      <PageHeader label="Wachstum" title="Wochenbericht" actions={<Button variant="primary" disabled={busy} onClick={() => void run(() => api(`/projects/${id}/reports/run`, { method: "POST", json: {} }))}>{busy ? "…" : "Wochen-Report jetzt erzeugen"}</Button>} />
      ...
      <div className="mp-two-col">
        <Card>
          <h2>Stücke nach Anmeldungen <span className="mp-muted mp-small">Signups über utm_content · Reichweite und Aufrufe stehen in der <Link to={`/projects/${id}/uebersicht`}>Übersicht</Link></span></h2>
