              ...
              <tbody>{p.pieces.map((pc) => (
                <>
                  <tr key={pc.pieceId}>
                    ...
                    <td className="mp-inline"><Button disabled={busy !== null} onClick={() => del(pc, "intermediates")}>Zwischendateien</Button><Button disabled={busy !== null} onClick={() => del(pc, "recordings")}>Aufnahmen</Button><Button variant="danger" disabled={busy !== null} onClick={() => del(pc, "all")}>Alles</Button></td>
                  </tr>
